...
export default function AddNewItemCard({ onClick }: AddNewItemCardProps) {
    return (
        <div
            onClick={onClick}
            className="group border-primary/30 from-primary/5 to-accent/5 hover:border-primary/50 relative aspect-square h-full w-full cursor-pointer rounded-2xl border-2 border-dashed bg-gradient-to-br p-6 transition-all duration-200 hover:shadow-lg"
        >
